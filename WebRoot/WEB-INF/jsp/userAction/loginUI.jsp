...
<s:form action="user_login" focusElement="loginNameInput">
    <div id="CenterAreaBg"> 
        <div id="CenterArea">
            ...
            <div id="CopyRight">
            <a href="javascript:void(0)">&copy; 2017 SSH itcastoa</a><br>
            <a href="test.jsp">&copy; GOTO test.jsp</a>
            </div>
        </div>
    ...
    <s:a action="user_list.action">
	   	<tr>
	   		<td rowspan="2" style="padding-left:20px;">
	           		<input type="image" tabindex="3" src="${pageContext.request.contextPath}/style/blue/images/login/userSign_button.jpg" />
	       	</td>
	    </tr>
	</s:a>
