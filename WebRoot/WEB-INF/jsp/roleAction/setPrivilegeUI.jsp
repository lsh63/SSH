...
<script type="text/javascript">
	$(function(){
		...
		$("[name=privilegeIds]").click(function(){
			...
			$(this).parent().siblings("ul").find("input").attr("checked",this.checked);
			
			// 当选中一个权限时，也要选中所有的直接上级权限
			if(this.checked == true){
					$(this).parents("li").children().children().attr("checked", true);
				}
		});
	});
							...
							<tr class="TableDetail1">
								...
								<td>
									...
									<%-- <s:iterator value="#privilegeList">
											<label><input type="checkbox" name="privilegeIds" value="${id}"
												...
												<li>
													...
													<s:iterator value="children">
														<li>
															<label><input type="checkbox" name="privilegeIds" value="${id}"
																<s:property value="%{id in privilegeIds ? 'checked' : ''}"/>
															/><span class="folder">${name}</span></label>
														</li>
													</s:iterator>
													</ul>
												</li>
