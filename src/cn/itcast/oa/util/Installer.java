...
public class Installer {
	...
	public void Install(){
		...
		// --------------------
				...
				menu1 = new Privilege("个人信息", "/person_show", menu);
				menu2 = new Privilege("密码修改", "/person_editUI", menu);
				session.save(menu);
				session.save(menu1);
				session.save(menu2);
				...
				menu1 = new Privilege("公司网站", "/gongsi_show", menu);
				menu2 = new Privilege("火车时刻", "/huoche_show", menu);
				menu3 = new Privilege("飞机航班", "/hangban_show", menu);
				menu4 = new Privilege("邮编/区号", "/emailNum_show", menu);
				menu5 = new Privilege("国际时间", "/time_show", menu);
				session.save(menu);
				session.save(menu1);
				session.save(menu2);
				session.save(menu3);
